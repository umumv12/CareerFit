...
- [ ] docs/AI_TA_[RULES.md](http://RULES.md) 작성 완료

- [ ] docs/[PROMPTS.md](http://PROMPTS.md) 바이브코딩 규칙 3개 이상 작성

- [ ] docs/[CHECKLIST.md](http://CHECKLIST.md) 작성 완료

- [ ] docs/EVAL_[QUESTIONS.md](http://QUESTIONS.md) 작성 완료

- [ ] docs/PROJECT_[PLAN.md](http://PLAN.md) 작성 완료
...
- [ ] [README.md](http://README.md) 골격 작성 완료
